...
import com.jumpy.tech.whatsappclone.messaging.domain.message.aggregate.ConversationBuilder;
...
import com.jumpy.tech.whatsappclone.infrastructure.secondary.entity.ConversationEntityBuilder;
...
public class ConversationEntity extends AbstractAuditingEntity<Long> {
    ...
    public static ConversationEntity from(Conversation conversation) {
      ...
      ConversationEntityBuilder conversationEntityBuilder = ConversationEntityBuilder.conversationEntity();
        ...
        if (conversation.getMessage() != null) {
            Set<MessageEntity> messages = conversation.getMessage()
    ...
    public static Conversation toDomain(ConversationEntity conversation) {
        ...
        if (conversation.getMessages() != null) {
            ...
            conversationEntityBuilder.message(MessageEntity.toDomain(conversation.getMessages()));
        }
    ...
    public static ConversationEntity from(ConversationToCreate conversation) {
        com.jumpy.tech.whatsappclone.infrastructure.secondary.entity.ConversationEntityBuilder conversationEntityBuilder = com.jumpy.tech.whatsappclone.infrastructure.secondary.entity.ConversationEntityBuilder.conversationEntity();
